	...
	return (
		<div id="HowItWorksSwiper" className="w-full">
			<div className="flex w-full flex-col items-center gap-[40px] relative">
				...
				>
					{cardLists?.map((item, index) => (
						<SwiperSlide key={index} className="flex justify-center">
							<div className="relative w-full rounded-2xl overflow-hidden shadow-[0_0_10px_0_#eeb9ca,0_0_4px_0_#f35185] mt-1 mb-1">
								<Image
									src={item.href}
									alt="dancing"
									width={800}
				...
				<div className="flex items-center justify-between w-[180px] h-[40px] md:w-full md:h-[60px] absolute bottom-[0px] md:top-[50%] md:translate-y-[-100%]">
					<button
						className={clsx(
							"group",
							"sertification-prev",
